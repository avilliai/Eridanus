...
from run.basic_plugin import call_weather_query,call_setu,call_image_search,call_tts,call_tarot,call_pick_music,call_fortune
...
from run.groupManager.self_Manager import call_operate_blandwhite,garbage_collection,report_to_master,send
...
from plugins.core.tts.tts import get_acgn_ai_speaker_list
