        ...
        if platform == "youtube":
            ...
            if match1:
                ...
                if type == "audio":
                    ...
                    if user_info.permission < config.streaming_media.config["流媒体"]["youtube"][
            ...
            if link_prising_json['status']:
                ...
                if link_prising_json['soft_type'] not in {'bilibili', 'dy', 'wb', 'xhs', 'x'}:
                    ...
                    return
                try:
                    video_json = await download_video_link_prising(link_prising_json, filepath='data/pictures/cache/',
                                                                   proxy=proxy)
