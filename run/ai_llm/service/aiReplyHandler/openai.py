...
async def openaiRequest(ask_prompt, url: str, apikey: str, model: str, stream: bool = False, proxy=None, tools=None,
                        instructions=None, temperature=1.3, max_tokens=2560):
...
async def openaiRequest_official(ask_prompt, url: str, apikey: str, model: str, stream: bool = False, proxy=None,
                                 tools=None, instructions=None, temperature=1.3, max_tokens=2560):
    """
    使用官方sdk
    :param ask_prompt:
    :param url:
...
async def construct_openai_standard_prompt(processed_message, system_instruction, user_id, bot=None, func_result=False,
                                           event=None):
...
async def construct_openai_standard_prompt_old_version(processed_message, system_instruction, user_id, bot=None,
                                                       func_result=False, event=None):
