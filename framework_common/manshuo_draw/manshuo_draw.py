...
async def manshuo_draw(json_img):
    img_path = await deal_img(json_check(json_img))
    return img_path
...
if __name__ == '__main__':
    ...
    contents = [
        ...
        {'type': 'img', 'subtype': 'common', 'img': ['framework_common/manshuo_draw/data/cache/manshuo.jpg',
    ...
    contentsWithNoTag = [
        ...
        {'type': 'img', 'subtype': 'common_with_des_right',
         'img': ['framework_common/manshuo_draw/data/cache/manshuo.jpg'], 'label': ['BiliBili'],
         'content': [
        ...
        '这部分是测manshuo！\n这manshuo！这里是测试！这里是测试！这里是测试！这里是测试！这里是测试！这里是测试\n[des]这里是介绍[/des]',
        {'type': 'img', 'subtype': 'common_with_des',
         'img': ['https://gal.manshuo.ink/usr/uploads/2025/02/1709218403.png'], 'label': ['BiliBili'],
         'content': [
             '这部分是测manshuo！\n这manshuo！这里是测试！这里是测试！这里是测试！这里是测试！这里是测试！这里是测试\n[des]这里是介绍[/des]']},
    ]
